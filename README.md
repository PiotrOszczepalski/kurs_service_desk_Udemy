...
1) Temat 1 - wprowadzenie:
   ...
   - omówienie Jira Service Desk (rodzaje ticketów np. incydent, service request; tworzenie ticketów; priorytety; SLA; statusy np. in progress, pending; przypisywanie zadań; korzystanie z Knowledge Base)
